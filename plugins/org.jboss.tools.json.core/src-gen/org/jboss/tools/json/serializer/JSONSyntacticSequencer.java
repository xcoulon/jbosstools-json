...
public class JSONSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected String getUnassignedRuleCallToken(EObject semanticObject, RuleCall ruleCall, INode node) {
		if(ruleCall.getRule() == grammarAccess.getTERMINAL_COMMARule())
			return getTERMINAL_COMMAToken(semanticObject, ruleCall, node);
		return "";
	}
	 ...
	 * ;
	 */
	protected String getTERMINAL_COMMAToken(EObject semanticObject, RuleCall ruleCall, INode node) {
		if (node != null)
